...
- **d7_paid_revenue**: revenue generated in the first `7` users installed the app on a given date.
- **d14_paid_revenue**: revenue generated in the first `14` users installed the app on a given date.
- ...
- **d360_paid_revenue**: revenue generated in the first `360` users installed the app on a given date.
...
Since we have to predict revenue for different time periods (D14, D30, D60, ..., D360), we will be building a model for each time period. The model will be a regression model and the target variable will be the revenue generated by the cohort in the given time period.
...
Just some of the data was used to train the model. A portion of the data (30% of the records) was saved for testing purposes to measure the accuracy of the models. 
